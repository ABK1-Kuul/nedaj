...
public class GasStationService {
    ...
    public void seedMockData() {
        ...
        GasStation s1 = new GasStation("ST001", "TotalEnergies Bole", "Bole", 12.0, 8.5);
        ...
        GasStation s2 = new GasStation("ST002", "NOC Megenagna", "Megenagna", 28.0, 15.0);
        ...
        GasStation s3 = new GasStation("ST003", "TotalEnergies Megenagna", "Megenagna", 30.0, 14.0);
        ...
        GasStation s4 = new GasStation("ST004", "NOC Bole", "Bole", 14.5, 9.0);
